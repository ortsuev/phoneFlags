...
// String currentLang = getCurrentLocaleLanguage as String;

List<Country> countries = countries;
List<Country> countriesget(String getCurrentLocaleLanguage) {
  if (getCurrentLocaleLanguage == 'de') {
    return countriesDE;
  } else {
    return countriesEN;
  }
...
const List<Country> countriesDE = [
  Country(
    name: "Afghanistan",
    flag: "🇦🇫",
    code: "AF",
  ...
  Country(
    name: "Heiliger Stuhl (Staat Vatikanstadt)",
    flag: "🇻🇦",
    code: "VA",
    dialCode: "379",
    minLength: 10,
  ...
  Country(
    name: "Palästinensische Gebiete, Besetzt",
    flag: "🇵🇸",
    code: "PS",
    dialCode: "970",
    minLength: 9,
...
//COUNTRIES DE ////////////////////////////////////////////////////////////////////////////////////////
const List<Country> countriesEN = [
  Country(
    name: "Afghanistan",
    flag: "🇦🇫",
    code: "AF",
